...
import com.spacesofting.weshare.domain.common.ApplicationWrapper.Companion.mailAutorize
...
import com.spacesofting.weshare.domain.common.utils.TimerUtils
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        autorize.setOnClickListener {
            ...
            if (loginText.text.isEmpty() || password.text.isEmpty()) {
                ...
                //  com.spacesofting.weshare.domain.common.Settings.checkAuthorization()
                //todo hide keyboard
            }
