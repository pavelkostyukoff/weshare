...
class SplashBackgroundView: ListView {
    ...
    val listScrollInitDelay = 2000L
    val listScrollSpeedFactor = 2000L // less means faster
    val listInitAnimationDuration = 100L
    val listDimmingSwitchRate = 3000L // once in a while will switch dimmed elements, less means more often
